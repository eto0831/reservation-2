...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'image_url' => "$baseImageUrl/images/shops/sushi.jpg", // 画像パス
        ];
        ...
        $param = [
            ...
            'image_url' => "$baseImageUrl/images/shops/yakiniku.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => "$baseImageUrl/images/shops/izakaya.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => "$baseImageUrl/images/shops/italian.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => "$baseImageUrl/images/shops/ramen.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
