...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'image_url' => "images/shops/sushi.jpg", // 画像パス
        ];
        ...
        $param = [
            ...
            'image_url' => "images/shops/izakaya.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => "images/shops/italian.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => "images/shops/ramen.jpg", // 画像パス
        ];
        DB::table('shops')->insert($param);
